...
TableProductListAll && new gridjs.Grid({
    columns: [{
        ...
        formatter: function(e) {
            // Changed here: Use window.ASSET_URL for Laravel asset path
            return gridjs.html('<div class="d-flex align-items-center"><div class="flex-shrink-0 me-3"><div class="avatar-sm bg-light rounded p-1"><img src="' + window.ASSET_URL + 'assets/images/products/' + e[0] + '" alt="" class="img-fluid d-block"></div></div><div class="flex-grow-1"><h5 class="fs-14 mb-1"><a href="apps-ecommerce-product-details.html" class="text-body">' + e[1] + '</a></h5><p class="text-muted mb-0">Category : <span class="fw-medium">' + e[2] + "</span></p></div></div>")
        }
    }, {
        name: "Stock",
        width: "94px"
...
var options, chart, swiper, linechartcustomerColors = getChartColorsArray("customer_impression_charts"),
    counterValue = (linechartcustomerColors && (options = {
        series: [{
            name: "Orders",
            type: "area",
    ...
    }, (chart = new ApexCharts(document.querySelector("#customer_impression_charts"), options)).render()), document.querySelector(".counter-value")),
    VerticalSwiper = (counterValue && (counter = document.querySelectorAll(".counter-value"), speed = 250, counter) && Array.from(counter).forEach(function(i) {
        ! function e() {
