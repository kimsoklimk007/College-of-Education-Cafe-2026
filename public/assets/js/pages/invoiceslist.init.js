...
var invoice_new_obj, str_dt = function(e) {
        var e = new Date(e),
    ...
    Invoices = [{
        ...
        img: window.location.origin + "/assets/images/users/avatar-2.jpg",
        ...
        invoice_no: "25000353",
        customer: "Jolie Hood",
        img: window.location.origin + "/assets/images/users/avatar-3.jpg",
        ...
        billing_address: {
            ...
            address: "Ap #957-7519 Vel, Belgium St. DiÃªm Äiá»n 88188-296",
        ...
        img: window.location.origin + "/assets/images/users/avatar-4.jpg",
        ...
        img: window.location.origin + "/assets/images/users/avatar-5.jpg",
        ...
        img: window.location.origin + "/assets/images/users/avatar-6.jpg",
        ...
        billing_address: {
            ...
            address: "5642 Aliquam, Avenue Zielona Costa Rica GÃ³ra 21204",
        ...
        invoice_no: "25000357",
        customer: "Jena Hall",
        img: window.location.origin + "/assets/images/users/avatar-7.jpg",
        ...
        shipping_address: {
            ...
            address: "150-7530 Egestas Av. PanchiÃ  Russian Federation 16807",
            phone: "(587) 848-3170",
            tax: "123456789"
        },
        prducts: [{
        ...
        img: window.location.origin + "/assets/images/users/avatar-8.jpg",
        ...
        billing_address: {
            ...
            address: "P.O. Box 583 Colombia, 2640 Aliquam Ave ToruÅ„ 456387",
        ...
        billing_address: {
            ...
            address: "176-4856 Hendrerit Av. France San Juan de GirÃ³n 58811-629",
            phone: "1-658-684-1084",
            tax: "123456789"
        },
        shipping_address: {
            full_name: "Georgia Nixon",
            address: "Ap #599-1431 Non, St. Cartagena del ChairÃ¡ United States 2548",
            phone: "1-658-684-1084",
            tax: "123456789"
        },
        prducts: [{
        ...
        billing_address: {
            ...
            address: "Ap #193-730 Orci, Chile Street San JosÃ© de Alajuela 8317",
            phone: "(470) 328-1309",
            tax: "123456789"
        },
        shipping_address: {
        ...
        shipping_address: {
            ...
            address: "630-5275 Quis Street KrakÃ³w Canada E39 0RE",
            phone: "1-989-241-7715",
            tax: "123456789"
        },
        prducts: [{
        ...
        shipping_address: {
            ...
            address: "P.O. Box 451, 696 Metus Avenue JaboatÃ£o dos Guararapes Colombia 391846",
            phone: "(256) 774-0737",
            tax: "123456789"
        },
        prducts: [{
        ...
        shipping_address: {
            ...
            address: "Ap #769-2743 Pede. Road GÃ¶nen Spain 83472-82897",
            phone: "1-544-454-6888",
            tax: "123456789"
        },
        prducts: [{
    ...
    checkAll = (null === localStorage.getItem("invoices-list") && null === localStorage.getItem("new_data_object") || (null === localStorage.getItem("invoices-list") && null !== localStorage.getItem("new_data_object") ? (invoice_new_obj = JSON.parse(localStorage.getItem("new_data_object")), Invoices.push(invoice_new_obj), localStorage.removeItem("new_data_object")) : (Invoices = [], Invoices = JSON.parse(localStorage.getItem("invoices-list")), null !== localStorage.getItem("new_data_object") && (invoice_new_obj = JSON.parse(localStorage.getItem("new_data_object")), Invoices.push(invoice_new_obj), localStorage.removeItem("new_data_object")), localStorage.removeItem("invoices-list"))), Array.from(Invoices).forEach(function(e) {
        let t;
        switch (e.status) {
            case "Paid":
                t = "success";
        ...
        a = e.img ? "<img src='" + e.img + "' alt='' class='avatar-xs rounded-circle me-2'>" : '<div class="flex-shrink-0 avatar-xs me-2"><div class="avatar-title bg-success-subtle text-success rounded-circle fs-13">' + (2 <= (a = e.customer.split(" ")).length ? a[0].slice(0, 1) + a[1].slice(0, 1) : a[0].slice(0, 1)) + "</div></div>";
        var a = `<tr>
                <th scope="row">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="chk_child" value="#KH${e.invoice_no}">
                    </div>
                </th>
                <td class="id"><a href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="` + e.invoice_no + '" class="fw-medium link-primary">#KH' + e.invoice_no + `</a></td>
    ...
    options = {
        valueNames: ["id", "customer_name", "email", "country", "date", "invoice_amount", "status"],
        page: perPage,
        pagination: !0,
    ...
    isValue = (isCount = (new DOMParser).parseFromString(invoiceList.items.slice(-1)[0]._values.id, "text/html")).body.firstElementChild.innerHTML,
...
var table = document.getElementById("invoiceTable"),
 ...
 if (document.querySelector('#idStatus')) {
        new Choices('#idStatus');
    }

function SearchData() {
    var i = document.querySelector('#idStatus')?.value,
    ...
    invoiceList.filter(function(e) {
        var t = (matchData = (new DOMParser).parseFromString(e.values().status, "text/html")).body.firstElementChild.innerHTML,
            ...
            n = !1,
            a = "all" == t || "all" == i || t == i,
            n = new Date(e.values().date.slice(0, 12)) >= new Date(r) && new Date(e.values().date.slice(0, 12)) <= new Date(s);
        ...
        e.addEventListener("click", function(e) {
            ...
            Array.from(e).forEach(function(e) {
                ...
                deleteid.body.firstElementChild.innerHTML == itemId && document.getElementById("delete-record").addEventListener("click", function() {
                    invoiceList.remove("id", t.outerHTML), document.getElementById("deleteRecord-close").click()
                })
            })
        })
    })
...
function clearFields() {
    customerNameField.value = "", emailField.value = "", dateField.value = "", countryField.value = ""
}

function ViewInvoice(e) {
    e = e.getAttribute("data-id");
    localStorage.setItem("invoices-list", JSON.stringify(Invoices)), localStorage.setItem("option", "view-invoice"), localStorage.setItem("invoice_no", e), window.location.assign("apps-invoices-details.html")
}

function EditInvoice(e) {
    e = e.getAttribute("data-id");
    localStorage.setItem("invoices-list", JSON.stringify(Invoices)), localStorage.setItem("option", "edit-invoice"), localStorage.setItem("invoice_no", e), window.location.assign("apps-invoices-create.html")
}

function deleteMultiple() {
    ids_array = [];
    var e = document.getElementsByName("chk_child");
    for (i = 0; i < e.length; i++) 1 == e[i].checked && ids_array.push(e[i].value);
    "undefined" != typeof ids_array && 0 < ids_array.length ? Swal.fire({
        ...
        if (e.value) {
            for (i = 0; i < ids_array.length; i++) invoiceList.remove("id", '<a href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="' + ids_array[i].slice(3) + `" class="fw-medium link-primary">${ids_array[i]}</a>`);
