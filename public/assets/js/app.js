...
! function () {
    ...
    function n(lang) {
        var headerImg = document.getElementById("header-lang-img");
        ...
        if (headerImg) {
            ...
            headerImg.src = window.location.origin + "/assets/images/flags/" + (flags[lang] || "us.svg");
        }
        localStorage.setItem("language", lang);

        var savedLang = localStorage.getItem("language") || "en";
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "/assets/lang/" + savedLang + ".json", true);
    ...
    sessionStorage.getItem("defaultAttribute") ? ((h = {})["data-layout"] = sessionStorage.getItem("data-layout"), h["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), h["data-bs-theme"] = sessionStorage.getItem("data-bs-theme"), h["data-layout-width"] = sessionStorage.getItem("data-layout-width"), h["data-sidebar"] = sessionStorage.getItem("data-sidebar"), h["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image"), h["data-layout-position"] = sessionStorage.getItem("data-layout-position"), h["data-layout-style"] = sessionStorage.getItem("data-layout-style"), h["data-topbar"] = sessionStorage.getItem("data-topbar"), h["data-preloader"] = sessionStorage.getItem("data-preloader"), h["data-body-image"] = sessionStorage.getItem("data-body-image"), h["data-theme"] = sessionStorage.getItem("data-theme"), h["data-theme-colors"] = sessionStorage.getItem("data-theme-colors"), e(h)) : (L = document.documentElement.attributes, h = {}, Array.from(L).forEach(function (e) {
    ...
    }), sessionStorage.setItem("defaultAttribute", JSON.stringify(h)), e(h), (L = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && L.click()), document.addEventListener("DOMContentLoaded", () => {
        const checkbox = document.getElementById("sidebarUserProfile");
        if (!checkbox) return;

        // Restore state
        checkbox.checked = sessionStorage.getItem("sidebarUserProfileChecked") === "true";
        document.documentElement.toggleAttribute("data-sidebar-user-show", checkbox.checked);

        // Save state on change
        checkbox.addEventListener("click", () => {
            sessionStorage.setItem("sidebarUserProfileChecked", checkbox.checked);
            document.documentElement.toggleAttribute("data-sidebar-user-show", checkbox.checked);
        });
        ...
        n["data-inline-date"] && (
            t.inline = !0,
            t.defaultDate = n["data-deafult-date"]
        ...
        n["data-week-number"] && (t.weekNumbers = !0),
