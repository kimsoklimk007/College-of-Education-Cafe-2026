    ...
    var p = {
            ...
            addedfile: function(e) {
                if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer && !this.options.disablePreviews) {
                    ...
                    // --- MODIFIED SWEETALERT SECTION START ---
                    var p = function(i) {
                        var n = t;
                        i.preventDefault();
                        i.stopPropagation();
                        ...
                        if (e.status === f.UPLOADING) {
                            Swal.fire({
                                text: t.options.dictCancelUploadConfirmation,
                                icon: 'warning',
                        ...
                        // Check if there is a general "Remove File" confirmation set
                        if (t.options.dictRemoveFileConfirmation) {
                            Swal.fire({
                                text: t.options.dictRemoveFileConfirmation,
                                icon: 'question',
                                showCancelButton: true,
                    ...
                    // --- MODIFIED SWEETALERT SECTION END ---
                        m = !0,
                        v = !1,
                        y = void 0;
                    try {
