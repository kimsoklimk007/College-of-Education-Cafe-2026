                                    ...
                                    <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/img-8.png') }}" alt="" class="img-fluid d-block">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('assets/images/img-6.png') }} " alt="" class="img-fluid d-block">
                                            </div>
                                            <div class="swiper-slide">
                                ...
                                <div class="mt-xl-0 mt-5">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div>
                                                <a href="{{ route('apps-ecommerce/add-product') }}" class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="ri-pencil-fill align-bottom"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                                                ...
                                                                <div class="border border-dashed rounded p-3">
                                                                    ...
                                                                    <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                        <a href="#" class="d-block">
                                                                            <img src="{{ asset('assets/images/img-12.jpg') }}" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                        </a>
                                                                        <a href="#" class="d-block">
                                                                            <img src="{{ asset('assets/images/img-11.jpg') }}" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                        </a>
                                                                        <a href="#" class="d-block">
                                                                            <img src="{{ asset('assets/images/img-10.jpg') }}" alt="" class="avatar-sm rounded object-fit-cover material-shadow">
                                                                        </a>
                                                                    </div>
