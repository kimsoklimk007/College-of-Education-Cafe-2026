...
@section('title', 'Details Invoice | Invoices')
@section('content')
    <!-- Page-content -->
                            ...
                            <div class="card-header border-bottom-dashed p-4">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 mt-sm-0 mt-3">
                                        ...
                                        <h6><span class="text-muted fw-normal">Email:</span><span id="email">starcodekh@gmail.com</span></h6>
                                        <h6><span class="text-muted fw-normal">Website:</span> <a href="https://souysoeng.com/" class="link-primary" target="_blank" id="website">www.souysoeng.com</a></h6>
                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    <div class="col-lg-3 col-6">
                                        ...
                                        <h5 class="fs-14 mb-0">#KH<span id="invoice-no">25000355</span></h5>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-3 col-6">
                                ...
                                <div class="border-top border-top-dashed mt-2">
                                    <table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Discount <small class="text-muted">(STACODE15)</small></td>
    ...
    <!-- End Page-content -->
    @section('script')
        <!-- invoicedetails init js -->
        <script src="{{ asset('assets/js/pages/invoicedetails.init.js') }}"></script>
    @endsection
@endsection