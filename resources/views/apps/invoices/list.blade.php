...
@section('title', 'Invoices List | Invoices')
@section('content')
    <!-- Page-content -->
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <a href="{{ route('apps-invoices/create') }}" class="btn btn-primary">
                            ...
                            <div class="row g-3">
                                <div class="col-xxl-4 col-sm-12">
                                    <div class="search-box">
                                        <input type="text" class="form-control search bg-light border-light" placeholder="Search invoices...">
