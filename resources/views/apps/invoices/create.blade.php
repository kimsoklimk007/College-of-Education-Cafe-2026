...
@section('title', 'Create Invoice | Invoices')
@section('content')
    <!-- Page-content -->
                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <input type="text" class="form-control bg-light border-0" id="invoicenoInput" placeholder="Invoice No" value="#KH25000355" readonly="readonly" />
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-sm-6">
                                    <div>
                                            ...
                                            <td colspan="2" class="p-0">
                                                <table class="table table-borderless table-sm table-nowrap align-middle mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th scope="row">Discount <small class="text-muted">(STARCODE15)</small></th>
                                                            <td>
