     ...
     <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
            <div class="row g-4">
                ...
                <div class="col">
                    <div class="p-2">
                        <h3 class="text-white mb-1">StarCode Kh</h3>
                        <p class="text-white text-opacity-75">Owner & Developer</p>
                        <div class="hstack text-white-50 gap-1">
                            <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>Cambodia, Phnom Penh</div>
                            <div>
                                <i class="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>StarCode Kh
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="d-flex profile-wrapper">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('pages/settings') }}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                        </div>
                    </div>
                    <!-- Tab panes -->
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">StarCode Kh</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">Cambodia, Phnom Penh
                                                            </td>
                                                        </tr>
                                                        <tr>
                                ...
                                <div class="col-xxl-9">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p>Hi I'm StarCode Kh, It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family.</p>
                                                ...
                                                <div class="col-6 col-md-4">
                                                    <div class="d-flex mt-4">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            ...
                                                            <a href="#" class="fw-semibold">www.Template.com</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                                        ...
                                                                        <div class="accordion-header" id="heading8">
                                                                            <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse8" aria-expanded="true">
                                                                                <div class="d-flex">
                                                                                    ...
                                                                                    <div class="flex-grow-1 ms-3">
                                                                                        <h6 class="fs-14 mb-1">
                                                                                            Template admin dashboard templates layout upload
                                                                                        </h6>
                                    ...
                                    <div class="acitivity-timeline">
                                                ...
                                                <div class="row">
                                                    <div class="col-xxl-4">
                                                        <div class="row border border-dashed gx-2 p-2 mb-2">
                                                            <div class="col-4">
                                                                <img src="{{ asset('assets/images/img-2.jpg') }}" alt="" class="img-fluid rounded material-shadow">
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-4">
                                                                <img src="{{ asset('assets/images/img-3.jpg') }}" alt="" class="img-fluid rounded material-shadow">
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-4">
                                                                <img src="{{ asset('assets/images/img-4.jpg') }}" alt="" class="img-fluid rounded material-shadow">
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                        <!--end row-->
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted mb-2">added a new member to Template dashboard</p>
                                        ...
                                        <div class="col-xxl-3 col-sm-6">
                                            <div class="card profile-project-card shadow-none profile-project-primary material-shadow">
                                                <div class="card-body p-4">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 text-muted overflow-hidden">
                                                            <h5 class="fs-14 text-truncate"><a href="#" class="text-body">Template Project</a></h5>
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="avatar-group">
                                                                    ...
                                                                    <div class="avatar-group-item material-shadow">
                                                                        <div class="avatar-xs">
                                                                            <img src="{{ asset('assets/images/avatar-5.jpg') }}" alt="" class="rounded-circle img-fluid">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="ms-3 flex-grow-1">
                                                                        <h6 class="fs-15 mb-0">
                                                                            <a href="javascript:void(0);">Template-logo.png</a>
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                            </td>
