...
@section('title', 'Profile Settings | Page')
@section('content')
    <!-- Page-content -->
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                <img src="{{ asset('assets/images/kim soklim.png') }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image material-shadow" alt="user-profile-image">
                            ...
                            <h5 class="fs-16 mb-1">StarCode Kh</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3 d-flex">
                            ...
                            <input type="text" class="form-control" id="websiteInput" placeholder="www.example.com" value="www.Template.com">
                        </div>
                        <div class="mb-3 d-flex">
                            <div class="avatar-xs d-block flex-shrink-0 me-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" id="emailInput" placeholder="Enter your email" value="daveadame@Template.com">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="websiteInput1" placeholder="www.example.com" value="www.Template.com">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3 pb-2">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea" placeholder="Enter your description" rows="3">Hi I'm StarCode Kh,It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family.</textarea>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="companyName" placeholder="Company name" value="StarCode Kh">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-lg-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-5">
                                                                <select class="form-control" data-choices="" data-choices-search-false="" name="experienceYear" id="experienceYear">
                                                                    ...
                                                                    <option value="Choice 23">2023</option>
                                                                    <option value="Choice 24">2024</option>
                                                                    <option value="Choice 25">2025</option>
                                                                </select>
                                                            </div>
                                                            <!--end col-->
                                                            ...
                                                            <div class="col-lg-5">
                                                                <select class="form-control" data-choices="" data-choices-search-false="" name="choices-single-default2">
                                                                    ...
                                                                    <option value="Choice 23">2023</option>
                                                                    <option value="Choice 24">2024</option>
                                                                    <option value="Choice 25" selected="">2025</option>
                                                                </select>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
